...
import { Component, Property, Event, closest, Collection, Complex, CreateBuilder, attributes } from '@syncfusion/ej2-base';
...
var Tab = (function (_super) {
    ...
    Tab.prototype.renderContainer = function () {
        ...
        if (!isNOU(select('.' + CLS_HEADER, this.element)) && !isNOU(select('.' + CLS_CONTENT, this.element))) {
            this.renderHeader();
            this.tbItems = select('.' + CLS_TB_ITEMS, this.element);
    ...
    Tab.prototype.parseObject = function (items) {
        ...
        items.forEach(function (item, index) {
            ...
            var wrap = buildTag('div', { className: CLS_WRAP, innerHTML: tCont, attrs: { tabIndex: '-1' } });
            var attrObj = {
    ...
    Tab.prototype.triggerAnimation = function (id, value) {
        ...
        var oldCnt = select('#' + this.prevActiveEle, this.element);
    ...
    Tab.prototype.setActiveBorder = function () {
        ...
        var hsCnt = select('.' + CLS_TB_ITEMS + ' .e-hscroll-content', this.element);
        this.tbItems = select('.' + CLS_TB_ITEMS, this.element);
        var bar = select('.' + CLS_INDICATOR, this.element);
...
export { Tab };
export var tabBuilder = CreateBuilder(Tab);
