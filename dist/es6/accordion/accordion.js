...
import { NotifyPropertyChanges, CreateBuilder, ChildProperty, Collection, Animation } from '@syncfusion/ej2-base';
...
export { Accordion };
export var accordionBuilder = CreateBuilder(Accordion);
