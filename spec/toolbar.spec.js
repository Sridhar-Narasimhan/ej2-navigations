define(["require", "exports", "@syncfusion/ej2-base/index", "@syncfusion/ej2-base/dom", "../src/toolbar/toolbar", "../src/common/h-scroll", "@syncfusion/ej2-buttons/src/button/button", "../node_modules/es6-promise/dist/es6-promise"], function (require, exports, index_1, dom_1, toolbar_1, h_scroll_1, button_1) {
    "use strict";
    ...
    describe('Toolbar Control', function () {
        var css = ".e-separator { border-right:1px solid; height: 15px; margin: 7.5px 3px} .e-toolbar .e-toolbar-items .e-toolbar-item.e-separator + .e-separator { display:none } .e-toolbar-items { display: inline-block; } .e-toolbar-items.e-hscroll { width:inherit; }  .e-toolbar .e-fix-width {width : 0px !important; } .e-toolbar .e-tbarpop  { position: fixed; } .e-toolbar-items .e-toolbar-item { display: inline-block; } .e-toolbar .e-hor-nav { float:right; width:30px; }  .e-toolbar .e-toolbar-pop { position: fixed;} ";
        var style = document.createElement('style');
        style.type = 'text/css';
        var styleNode = style.appendChild(document.createTextNode(css));
        document.getElementsByTagName('head')[0].appendChild(style);
        describe('Dom toolbar element', function () {
            var toolbar;
            beforeEach(function () {
                toolbar = undefined;
                var ele = dom_1.createElement('div', { id: 'ej2Toolbar' });
        ...
        describe('Main Property testing', function () {
            ...
            it('Item button property testing', function () {
                toolbar = new toolbar_1.Toolbar({
                    items: [
                        {
                            type: 'Button',
                ...
                toolbar.appendTo('#ej2Toolbar');
                var element = document.getElementsByClassName('e-toolbar')[0];
            ...
            it('Width property as number testing', function () {
                toolbar = new toolbar_1.Toolbar({
                    width: 500
                });
                toolbar.appendTo('#ej2Toolbar');
            ...
            it('Width property as string testing', function () {
                toolbar = new toolbar_1.Toolbar({
            ...
            it('Height property as number testing', function () {
                toolbar = new toolbar_1.Toolbar({
                    height: 500
                });
                toolbar.appendTo('#ej2Toolbar');
            ...
            it('Height property as string testing', function () {
                toolbar = new toolbar_1.Toolbar({
            ...
            it('Height property sets throught onPropertyChange', function () {
                toolbar = new toolbar_1.Toolbar({
            ...
            it('Item separator property testing', function () {
                toolbar = new toolbar_1.Toolbar({
                    items: [
                        {
                            type: 'Separator',
        ...
        describe('Persistance testing', function () {
            var toolbar;
            beforeEach(function () {
                toolbar = undefined;
                var ele = dom_1.createElement('div', { id: 'ej2Toolbar' });
                dom_1.setStyleAttribute(ele, { 'display': 'block', 'white-space': 'nowrap', 'position': 'relative' });
            ...
            it('Overflow style as scroll testing', function () {
        ...
        describe('Event and destroy function testing', function () {
            var toolbar;
            var i = 0;
            function clickFn() {
                i++;
            ...
            it('BeforeCreate,create and click event testing', function () {
                toolbar = new toolbar_1.Toolbar({
                    width: '500px',
                    created: clickFn,
                    destroyed: clickFn,
            ...
            it('Destroy event and function testing', function () {
                var element = document.getElementById('ej2Toolbar');
                expect(i).toEqual(4);
        ...
        describe('onPropertyChanged function testing', function () {
            var toolbar;
            beforeEach(function () {
                toolbar = undefined;
                var ele = dom_1.createElement('div', { id: 'ej2Toolbar' });
            ...
            it('Width property as number testing', function () {
                toolbar = new toolbar_1.Toolbar({ items: [{ type: 'Separator' }] });
                toolbar.appendTo('#ej2Toolbar');
                toolbar.width = 500;
                toolbar.dataBind();
                var element = document.getElementById('ej2Toolbar');
            ...
            it('Width property as empty string testing', function () {
                toolbar = new toolbar_1.Toolbar({ items: [{ type: 'Separator' }] });
                toolbar.appendTo('#ej2Toolbar');
                toolbar.width = '';
                toolbar.dataBind();
        ...
        describe('Overflow content Testing', function () {
            var toolbar;
            beforeEach(function () {
                toolbar = undefined;
                var ele = dom_1.createElement('div', { id: 'ej2Toolbar' });
            ...
            it('Overflow style as hidden testing', function () {
                toolbar = new toolbar_1.Toolbar({
                    items: [{
                            type: 'Button', text: 'Bold',
                        }],
            ...
            it('Overflow style as scroll testing', function () {
                ...
                toolbar.appendTo('#ej2Toolbar');
                var element = document.getElementById('ej2Toolbar');
                var innerelement = element.getElementsByClassName('e-toolbar-items');
                dom_1.setStyleAttribute(innerelement[0], { display: 'inline-block' });
                dom_1.setStyleAttribute(element.getElementsByClassName('e-toolbar-item')[0], { display: 'inline-block' });
                toolbar.items = [{
                        type: 'Button', text: 'Bold',
                    }];
                toolbar.dataBind();
                var scrollELe = element.children[0];
                expect(scrollELe.classList.contains('e-hscroll')).toEqual(true);
            });
            it('Overflow navigation testing', function () {
                toolbar = new toolbar_1.Toolbar({
                    width: 30,
                    items: [{
                            type: 'Button', text: 'Bold',
                ...
                var scrollELe = element.children[0];
                expect(scrollELe.classList.contains('e-hscroll')).toEqual(true);
                var innerNavEle = scrollELe.children[0];
                expect(innerNavEle.classList.contains('e-hor-nav')).toEqual(true);
                var innerNavElement = innerNavEle.querySelector('.e-icons');
        ...
        describe('Overflow content horizontal scrolling  Testing', function () {
            var toolbar;
            it('Overflow navigation horizontal scrolling event handler testing', function () {
                toolbar = undefined;
                var ele = dom_1.createElement('div', { id: 'ej2Toolbar' });
                dom_1.setStyleAttribute(ele, { 'display': 'block', 'white-space': 'nowrap', 'position': 'relative' });
                ele.style.display = 'block';
                ...
                toolbar.dataBind();
                expect(scrollELe.classList.contains('e-hscroll')).toEqual(true);
                var innerNavElement = scrollELe.children[0];
                var innerArrowEle = innerNavElement.querySelector('.e-icons');
                expect(innerArrowEle.classList.contains('e-nav-right-arrow')).toEqual(true);
                var scrollEvent = document.createEvent('MouseEvents');
                var scrollCon = element.querySelector('.e-hscroll-bar');
                scrollEvent.initEvent('scroll', false, false);
            ...
            it('Overflow navigation event handler testing', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 20,
                });
        ...
        describe('Main property OverflowMode testing', function () {
            var toolbar;
            document.body.innerHTML = '';
            beforeEach(function () {
                toolbar = undefined;
            ...
            it(' Main property OverflowMode given as enum testing', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 30,
            ...
            it(' Main property OverflowMode given as string testing', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 30,
                    overflowMode: "Scrollable",
        ...
        describe(' Html attributes property testing in items main property', function () {
            var toolbar;
            document.body.innerHTML = '';
            beforeEach(function () {
                toolbar = undefined;
            ...
            it('Html attributes property giving as role', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 30,
                    overflowMode: "Popup",
                ...
                toolbar.appendTo('#ej2Toolbar');
                var ele = element.getElementsByClassName('e-toolbar-item')[0];
                expect(ele.getAttribute('role')).toEqual('Toolbar');
            });
            it('Html attributes property giving as class', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 30,
                    overflowMode: "Popup",
            ...
            it('Html attributes property giving as style', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 30,
                    overflowMode: "Popup",
        ...
        describe('Tooltip text property testing in items main property', function () {
            var toolbar;
            document.body.innerHTML = '';
            beforeEach(function () {
                toolbar = undefined;
            ...
            it('Tooltip text given as string', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 30,
                    overflowMode: "Popup",
        ...
        describe('Width property testing in items main property', function () {
            var toolbar;
            document.body.innerHTML = '';
            beforeEach(function () {
                toolbar = undefined;
            ...
            it('Width property testing', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    items: [{
                ...
                toolbar.appendTo('#ej2Toolbar');
                var ele = element.querySelector('.e-toolbar-item');
                var innerEle = ele.querySelector('button');
                expect(innerEle.style.width).toEqual('50px');
            });
        });
        describe('Prefix Icon property testing in items main property', function () {
            var toolbar;
            document.body.innerHTML = '';
            beforeEach(function () {
                toolbar = undefined;
            ...
            it('Prefix Icon property testing', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    items: [{
                ...
                expect(innerEle.children[0].classList.contains('e-prefix-icon')).toEqual(true);
                expect(innerEle.children[1].classList.contains('e-tbar-btn-text')).toEqual(true);
            });
        });
        describe('Id  property testing in items main property', function () {
            var toolbar;
            document.body.innerHTML = '';
            beforeEach(function () {
                toolbar = undefined;
            ...
            it('Suffix Icon property testing', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    items: [{
        ...
        describe('Suffix Icon property testing in items main property', function () {
            var toolbar;
            document.body.innerHTML = '';
            beforeEach(function () {
                toolbar = undefined;
            ...
            it('Suffix Icon property testing', function () {
                ...
                var innerEle = ele.querySelector('button');
                expect(innerEle.children.length).toEqual(2);
                expect(innerEle.children[1].classList.contains('e-suffix-icon')).toEqual(true);
                expect(innerEle.children[0].classList.contains('e-tbar-btn-text')).toEqual(true);
            });
        });
        describe('Prefix Icon and Suffix icon property testing in items main property', function () {
            var toolbar;
            document.body.innerHTML = '';
            beforeEach(function () {
                toolbar = undefined;
        ...
        describe('ShowtexOn property testing in items main property', function () {
            var toolbar;
            document.body.innerHTML = '';
            beforeEach(function () {
                toolbar = undefined;
            ...
            it('showtextOn given as string with Popup', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 30,
                    overflowMode: "Popup",
            ...
            it('showtextOn given as string', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 170,
                    overflowMode: "Popup",
            ...
            it('showtextOn given as string', function () {
                ...
                expect(element.querySelectorAll('.e-toolbar-item')[0].classList.contains('e-toolbar-text')).toEqual(false);
            });
        });
        describe('Popuped element height testing based on toolbar height', function () {
            var toolbar;
            document.body.innerHTML = '';
            beforeEach(function () {
                toolbar = undefined;
            ...
            it('Popuped element height testing', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    height: 40,
                    width: 100,
                ...
                toolbar.appendTo('#ej2Toolbar');
                var popupEle = toolbar.popupObj.element.querySelector('.e-toolbar-item');
                expect(popupEle.style.height === '').toEqual(false);
            });
        });
        describe('Template property testing in items main property', function () {
            var toolbar;
            beforeEach(function () {
                toolbar = undefined;
                var ele = dom_1.createElement('div', { id: 'ej2Toolbar' });
                ...
                ele.style.display = 'block';
                document.body.appendChild(ele);
                var button = dom_1.createElement('Button', { id: 'Template' });
                button.innerHTML = 'Template1';
                document.body.appendChild(button);
                new button_1.Button({}, '#Template');
            });
            afterEach(function () {
                if (toolbar) {
                    toolbar.destroy();
            ...
            function creatfunction(e) {
                new button_1.Button({}, '#Template1');
            }
            it('Template text given as string', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 30,
                    overflowMode: "Popup",
            ...
            it('Template text given as string as Element', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 30,
            ...
            it('Template given as Interface', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    created: creatfunction,
                    overflowMode: "Popup",
                    items: [{ template: new button_1.Button({}), type: 'Input', text: 'Underline', tooltipText: 'Bold', }],
                });
                toolbar.appendTo('#ej2Toolbar');
                var template = element.querySelector('.e-template input');
            ...
            it('Template given as Interface with Type others', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    created: creatfunction,
                    overflowMode: "Popup",
                    items: [{ template: new button_1.Button({}), id: 'input_ID', type: 'Button', text: 'Underline', tooltipText: 'Bold', }],
                });
                toolbar.appendTo('#ej2Toolbar');
                var template = element.querySelectorAll('#input_ID');
                expect(template.length === 0).toEqual(true);
            });
            it('Template given as Interface with Id', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    created: creatfunction,
                    overflowMode: "Popup",
                    items: [{ template: new button_1.Button({}), id: 'input_ID', type: 'Input', text: 'Underline', tooltipText: 'Bold', }],
                });
                toolbar.appendTo('#ej2Toolbar');
                var template = element.querySelector('.e-template input');
                expect(element.querySelector('.e-template').classList.contains('e-toolbar-item')).toEqual(true);
            ...
            it('Template given as Interface with EnumType', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    created: creatfunction,
                    overflowMode: "Popup",
        ...
        describe('Overflow property testing in items Prob', function () {
            var toolbar;
            document.body.innerHTML = '';
            beforeEach(function () {
                toolbar = undefined;
            ...
            it('Overflow priority sets "Show" as string', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 30,
            ...
            it('Overflow priority sets "Show" as enum', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 30,
                    items: [{ type: 'Button', text: 'Underline', overflow: 'Show', tooltipText: 'Bold', }],
            ...
            it('Overflow property popup control testing div element testing', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 30,
                    overflowMode: 'Popup',
                ...
                expect(dom_1.isVisible(element.querySelector('.e-popup'))).toEqual(false);
            });
            it('Overflow property popup control testing div element testing', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
            ...
            it('Overflow property popup control testing navigation icon testing', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 30,
                    overflowMode: 'Popup',
            ...
            it('Overflow property popup control testing popup opening and closing Testing', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 30,
                    overflowMode: 'Popup',
                ...
                toolbar.appendTo('#ej2Toolbar');
                var pop_Nav = document.getElementById(element.id + '_nav');
                var nav_icon = pop_Nav.firstChild;
                pop_Nav.click();
                var tool = toolbar;
                tool.popupObj.show();
                expect(dom_1.isVisible(element.querySelector('.e-popup'))).toEqual(true);
                expect(nav_icon.classList.contains('e-popup-up-icon')).toEqual(true);
                expect(dom_1.isVisible(element.querySelector('.e-popup .e-toolbar-item'))).toEqual(true);
            ...
            it('Overflow property popup control testing popup priority wise alignment testing', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 30,
                    overflowMode: 'Popup',
                ...
                expect(element.querySelectorAll('.e-popup .e-toolbar-item')[1].classList.contains('e-overflow-show')).toEqual(true);
                expect(element.querySelectorAll('.e-popup .e-toolbar-item')[2].classList.contains('e-overflow-show')).toEqual(false);
                expect(element.querySelectorAll('.e-popup .e-toolbar-item.e-overflow-show').length == 2).toEqual(true);
            });
            it('Overflow property popup control OverflowOption testing', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 100,
                    overflowMode: 'Popup',
                ...
                expect(element.querySelectorAll('.e-toolbar-items .e-toolbar-item')[0].classList.contains('e-overflow-show')).toEqual(true);
            ...
            it('Overflow property popup control OverflowOption give Hide as string', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 200,
                    overflowMode: 'Popup',
                ...
                expect(element.querySelectorAll('.e-toolbar-items .e-toolbar-item')[0].classList.contains('e-overflow-show')).toEqual(false);
                expect(element.querySelectorAll('.e-toolbar-items .e-toolbar-item')[1].classList.contains('e-overflow-show')).toEqual(false);
                expect(element.querySelectorAll('.e-toolbar-items .e-toolbar-item')[2].classList.contains('e-overflow-show')).toEqual(true);
            ...
            it('Overflow property popup control OverflowOption With separator', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 70,
                    overflowMode: 'Popup',
            ...
            it('Overflow property popup control testing popup element refresh with increasing width', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 30,
                    overflowMode: 'Popup',
                ...
                toolbar.appendTo('#ej2Toolbar');
                expect(element.querySelectorAll('.e-popup .e-toolbar-item').length == 2).toEqual(true);
                element.querySelector('.e-toolbar-items').classList.add('e-fix-width');
                toolbar.width = 100;
                toolbar.dataBind();
            ...
            it('Overflow property popup control testing popup element refresh with decreasing width', function () {
                var element = document.getElementById('ej2Toolbar');
                toolbar = new toolbar_1.Toolbar({
                    width: 140,
                    overflowMode: 'Popup',
            ...
            describe(' Text property in items toolbar testing', function () {
                var toolbar;
                document.body.innerHTML = '';
                beforeEach(function () {
                    toolbar = undefined;
                ...
                it(' Text property testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 30,
            ...
            describe(' Touch event (scroll and swipe) handler testing', function () {
                var toolbar;
                document.body.innerHTML = '';
                beforeEach(function () {
                    toolbar = undefined;
                ...
                it('Touch event scroll testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    var scroll;
                    toolbar = new toolbar_1.Toolbar({
                        width: 50,
                    ...
                    expect(scrollELe.classList.contains('e-hscroll')).toEqual(true);
                    var TchEvent;
                    var event = { scrollDirection: 'Right', name: 'scroll', distanceX: 30, distanceY: 0, originalEvent: TchEvent, startEvents: TchEvent, startX: 30, startY: 0, velocity: 4 };
                    scroll = new h_scroll_1.HScroll({}, element);
            ...
            describe('Resize testing', function () {
                var toolbar;
                document.body.innerHTML = '';
                beforeEach(function () {
                    toolbar = undefined;
            ...
            describe(' Keyboard Interaction testing', function () {
                var toolbar;
                var keyEventArgs;
                document.body.innerHTML = '';
                beforeEach(function () {
                ...
                it('allowKeyboardInteraction Property testing ', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 170,
                        overflowMode: 'Popup',
                ...
                it('Right arrow Key Testing select option', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 170,
                        overflowMode: 'Scrollable',
                ...
                it('Right arrow Key  without Element testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 170,
                        overflowMode: 'Scrollable',
                ...
                it('Right arrow Key with toolbar element Focusing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 50,
                        overflowMode: 'Scrollable',
                ...
                it('Right arrow Key  with inbetween Separator testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 170,
                        overflowMode: 'Scrollable',
                ...
                it('Right arrow Key  with multiple Separator testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 170,
                        overflowMode: 'Scrollable',
                ...
                it('Left arrow Key  with multiple Separator testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 170,
                        overflowMode: 'Scrollable',
                ...
                it('Tab Key testing with item Click', function () {
                    var element = document.getElementById('ej2Toolbar');
                    var ele = dom_1.createElement('input', { id: 'input1' });
                    var ele1 = dom_1.createElement('input', { id: 'input2' });
                    ele.type = 'text';
                    ele1.type = 'text';
                    ...
                    expect(element.classList.contains('e-keyboard')).toEqual(true);
                    toolbar.keyActionHandler(keyEventArgs);
                    var el = toolbar.element.querySelectorAll('.e-toolbar-item')[0].firstChild;
                    expect(document.activeElement.children[0].innerHTML).toEqual('New');
                ...
                it('Tab key with Document testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    var btn = dom_1.createElement('button', { id: 'focusButton' });
                    var btn1 = dom_1.createElement('button', { id: 'focusButton1' });
                ...
                it('Tab key without items testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    var btn = dom_1.createElement('button', { id: 'focusButton' });
                    var btn1 = dom_1.createElement('button', { id: 'focusButton1' });
                    element.parentElement.insertBefore(btn, element);
                ...
                it('Move Left with Focusing Navigation testing without Separator', function () {
                    var element = document.getElementById('ej2Toolbar');
                    var btn = dom_1.createElement('button', { id: 'focusButton' });
                    var btn1 = dom_1.createElement('button', { id: 'focusButton1' });
                    element.parentElement.insertBefore(btn, element);
                ...
                it('Move Left with Focusing Navigation testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    var btn = dom_1.createElement('button', { id: 'focusButton' });
                    var btn1 = dom_1.createElement('button', { id: 'focusButton1' });
                    element.parentElement.insertBefore(btn, element);
                ...
                it('Right arrow Key  with last element as Separator testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 170,
                        overflowMode: 'Scrollable',
                ...
                it('Left arrow Key   testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 170,
                        overflowMode: 'Scrollable',
                ...
                it('Left arrow Key  without Element in left side testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        overflowMode: 'Popup',
                        width: 100,
                ...
                it('Left arrow Key  with in between Separator  testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        overflowMode: 'Popup',
                        items: [
                ...
                it('Left arrow Key  with Separator as first element  testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        overflowMode: 'Popup',
                        items: [{ type: 'Separator' },
                ...
                it('Up arrow Key   testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 30,
                        overflowMode: 'Popup',
                ...
                it('Up arrow Key  without Popup  testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 170,
                        overflowMode: 'Scrollable',
                ...
                it('Down arrow Key    testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 30,
                        overflowMode: 'Popup',
                ...
                it('Down arrow Key  without Popup  testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 170,
                        overflowMode: 'Scrollable',
            ...
            describe(' Public methods add items Testing', function () {
                var toolbar;
                document.body.innerHTML = '';
                beforeEach(function () {
                    toolbar = undefined;
                ...
                it('addItem method Testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 250,
                        overflowMode: 'Popup',
                ...
                it('addItem method without passing index', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 250,
                        overflowMode: 'Popup',
            ...
            describe(' Public methods remove items Testing', function () {
                var toolbar;
                document.body.innerHTML = '';
                beforeEach(function () {
                    toolbar = undefined;
                ...
                it(' removeItems method Testing using index', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 250,
                        overflowMode: 'Popup',
            ...
            describe(' Public methods enableItems Testing', function () {
                var toolbar;
                document.body.innerHTML = '';
                beforeEach(function () {
                    toolbar = undefined;
                ...
                it(' enableItems method Testing ', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 250,
                        overflowMode: 'Popup',
                ...
                it(' enableItems method Testing without passing 2nd args ', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 250,
                        overflowMode: 'Popup',
            ...
            describe('Resize testing with Scrolling and Popup Mode', function () {
                var toolbar;
                document.body.innerHTML = '';
                beforeEach(function () {
                    toolbar = undefined;
                ...
                it('Resize testing', function () {
                    ...
                    toolbar.appendTo('#ej2Toolbar');
                    var popNav = element.querySelectorAll('.e-hor-nav');
                ...
                it('Resize testing', function () {
                    ...
                    expect(element.querySelectorAll('.e-toolbar-items .e-toolbar-item')[2].classList.contains('e-separator')).toEqual(true);
                    expect(element.querySelectorAll('.e-toolbar-items .e-toolbar-item')[3].querySelector('button').children[0].innerHTML).toEqual('UnderlineBtn');
                });
                it('Resize testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
            ...
            describe('Resize testing with Popup priority', function () {
                var toolbar;
                document.body.innerHTML = '';
                beforeEach(function () {
                    toolbar = undefined;
                ...
                it('Resize with Priority', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 180,
                        overflowMode: 'Popup',
                ...
                it('Resize with Priority Separator', function () {
                    var element = document.getElementById('ej2Toolbar');
                    var separator;
                    toolbar = new toolbar_1.Toolbar({
                        width: 200,
                    ...
                    var itemCollection = element.querySelectorAll('.e-toolbar-items .e-toolbar-item');
                    expect(itemCollection.length).toEqual(4);
                    separator = itemCollection[3];
                ...
                it('Resize with popup without text item case', function () {
                    var element = document.getElementById('ej2Toolbar');
                    var separator;
                    toolbar = new toolbar_1.Toolbar({
                        width: 210,
                ...
                it('Resize with popup without text item with showtexton toolbar mode', function () {
                    var element = document.getElementById('ej2Toolbar');
                    var separator;
                    toolbar = new toolbar_1.Toolbar({
                        width: 210,
                ...
                it('Resize with popup without text and showtexton case', function () {
                    var element = document.getElementById('ej2Toolbar');
                    var separator;
                    toolbar = new toolbar_1.Toolbar({
                        overflowMode: 'Popup',
                ...
                it('Resize with combined priority with multiple separator', function () {
                    var element = document.getElementById('ej2Toolbar');
                    var separator;
                    toolbar = new toolbar_1.Toolbar({
                        width: 200,
            ...
            describe('onproperty change popup', function () {
                var toolbar;
                document.body.innerHTML = '';
                beforeEach(function () {
                    toolbar = undefined;
                ...
                it('onproperty change popup', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 50,
                        items: [
                ...
                it('onproperty change popup without hscroll Module', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        items: [
                            {
                ...
                it('onproperty change popup with RTL', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 50,
                        enableRtl: true,
                ...
                it('onproperty change Scrollable', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 100,
                        overflowMode: 'Popup',
                ...
                it('onproperty change Scrollable with RTL', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 250,
                        enableRtl: true,
            ...
            describe('Popup Priority Testing', function () {
                var toolbar;
                document.body.innerHTML = '';
                beforeEach(function () {
                    toolbar = undefined;
                ...
                it('Popup Priority Testing check', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        overflowMode: 'Popup',
                        width: 170,
            ...
            describe('RTL testing', function () {
                ...
                it('rtl class adding check', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        width: 170,
                        enableRtl: true,
                ...
                it('rtl class adding check with popup', function () {
                    var element = document.getElementById('ej2Toolbar');
                    var innerNavElement = element.querySelector('.e-hor-nav');
                    toolbar = new toolbar_1.Toolbar({
                        overflowMode: 'Popup',
                        width: 170,
                        items: [
                ...
                it('rtl class adding check  with on property change ', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        overflowMode: 'Popup',
                        width: 170,
                ...
                it('rtl class adding check  with on proerty change ', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        overflowMode: 'Popup',
                        width: 170,
            ...
            describe('Aria attributes Testing', function () {
                var toolbar;
                document.body.innerHTML = '';
                beforeEach(function () {
                    toolbar = undefined;
                ...
                it('Toolbar root element aria testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({
                        overflowMode: 'Popup',
                        items: [
            ...
            describe('Template Toolbar Testing with div', function () {
                var toolbar;
                document.body.innerHTML = '';
                beforeEach(function () {
                    toolbar = undefined;
                    document.body.innerHTML = '';
                    var ele = dom_1.createElement('div', { id: 'ej2Toolbar' });
                    var innerEle = dom_1.createElement('div');
                    var innerEle1 = dom_1.createElement('div');
                    var innerEle_1 = dom_1.createElement('div', { className: 'e-toolbar-item' });
                    var innerEle_ = dom_1.createElement('div');
                ...
                it('Template Toolbar Testing', function () {
                    var element = document.getElementById('ej2Toolbar');
                    toolbar = new toolbar_1.Toolbar({}, '#ej2Toolbar');
                    expect(element.querySelectorAll('.e-toolbar-items').length === 1).toEqual(true);
                    var innerEle = element.querySelector('.e-toolbar-items');
                    expect(innerEle.children[0].classList.contains('e-toolbar-item')).toEqual(true);
                    expect(innerEle.children[1].classList.contains('e-toolbar-item')).toEqual(true);
                });
            });
            describe('Template Toolbar Testing with span', function () {
                var toolbar;
                document.body.innerHTML = '';
                beforeEach(function () {
                    toolbar = undefined;
                    ...
                    var innerEle1 = dom_1.createElement('div');
                    var innerEle_1 = dom_1.createElement('div', { className: 'e-toolbar-item' });
                    var innerEle_ = dom_1.createElement('span');
                    innerEle.appendChild(innerEle_);
                    innerEle.appendChild(innerEle_1);
                    ele.appendChild(innerEle);
                    document.body.appendChild(ele);
                ...
                it('Template Toolbar Testing', function () {
                    ...
                    expect(element.querySelectorAll('.e-toolbar-items').length === 1).toEqual(true);
                    var innerEle = element.querySelector('.e-toolbar-items');
                    expect(innerEle.children[0].classList.contains('e-toolbar-item')).toEqual(false);
                    expect(innerEle.children[1].classList.contains('e-toolbar-item')).toEqual(true);
                });
            });
        });
        describe('Cross Browser Testing with IE popup icon alignment', function () {
            var toolbar;
            var keyEventArgs;
            document.body.innerHTML = '';
            beforeEach(function () {
            ...
            it('Cross browser Testing with IE', function () {
                ...
                toolbar.appendTo('#ej2Toolbar');
                var popupNav = toolbar.element.querySelector('.e-hor-nav');
                expect(popupNav.classList.contains('e-ie-align')).toEqual(true);
            });
        });
        describe('Popup Open animation testing with animation', function () {
            var toolbar;
            var keyEventArgs;
            document.body.innerHTML = '';
            ...
            it('popup Open througth keyboard testing ', function () {
                expect(dom_1.isVisible(toolbar.popupObj.element)).toEqual(true);
                toolbar.popupObj.hide();
            });
        });
        describe('Popup Open animation  testing in keyboard in opened state with animation', function () {
            var toolbar;
            var keyEventArgs;
            document.body.innerHTML = '';
            beforeEach(function (done) {
        ...
        describe('Popup Close animation testing with animation', function () {
            var toolbar;
            var keyEventArgs;
            document.body.innerHTML = '';
            beforeEach(function (done) {
            ...
            it('popup close with througth keyboard testing with animation', function () {
                expect(dom_1.isVisible(toolbar.popupObj.element)).toEqual(false);
            });
        });
        describe('Popup Close animation testing with animation', function () {
            var toolbar;
            ...
            it('popup close with througth keyboard testing without popup opened ', function () {
                expect(dom_1.isVisible(toolbar.popupObj.element)).toEqual(false);
            });
        });
        describe('Popup with more content overflow testing', function () {
            var toolbar;
            var keyEventArgs;
            document.body.innerHTML = '';
            beforeEach(function (done) {
            ...
            it('popup opened with content overflow testing', function () {
                var element = document.getElementById('ej2Toolbar');
